...
$(function () {
    ...
    h4.each(function(i) {
        $(this).click(function() {
            ...
            if($(this).next().length == 0) {
                ...
                // 改变字体颜色
                $(".tree-item-h4").removeClass("tree-three-active");
                $(this).toggleClass("tree-three-active");
                // console.log($(this).parent().siblings().find(".tree-item-h4"));

                // 修复假二级菜单背景异常出现
                $(this).parent().siblings().find(".tree-item-h4").each(function (i) {
    ...
    // 如果只有二级菜单
    var el33 = $(".tree-item-h4").eq(33);
    setInterval(function () {
        // console.log(el33);
        if (!el33.css("backgroundImage")) {
            console.log(el33.css("backgroundImage"));
        }
    }, 1000)
