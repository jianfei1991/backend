        ...
        if (arr[i].next != undefined) {
            ...
            for (var j = 0; j < arr[i].next.length; j++) {
                ...
                if (arr[i].next[j].next != undefined) {
                    ...
                    if (arr[i].next[j].next != undefined) {
                        ...
                        for (var k = 0; k < arr[i].next[j].next.length; k++) {
                            ...
                            if (arr[i].next[j].next[k].next != undefined) {
                                ...
                                for (var m = 0; m < arr[i].next[j].next[k].next.length; m++) {
                                    ...
                                    if (arr[i].next[j].next[k].next[m].next != undefined) {
                                        ...
                                        for (var n = 0; n < arr[i].next[j].next[k].next[m].next.length; n++) {
                                            ...
                                            var fiveTarget = arr[i].next[j].next[k].next[m].next[n].target;
                                            var liiii = $('<li class="tree-item-last tree-single tree-jump" data-url="' + fiveUrl + '" data-target="' + fiveTarget + '" onclick="jump(this, \'' + rootPath + fiveUrl + '\')">' + fiveVal + '</li>');
                                        ...
                                        var liTarget = arr[i].next[j].next[k].next[m].target;
                                        if (!!liUrl) {
                                            var liEl4 = $('<h6 class="tree-item-h6-single tree-single tree-jump" data-url="' + liUrl + '" data-target="' + liTarget + '" onclick="jump(this, \'' + rootPath + liUrl + '\')">' + liVal + '</h6>');
                                        } else {
                                ...
                                var liTarget = arr[i].next[j].next[k].target;
                                if (!!liUrl) {
                                    var liEl3 = $('<h5 class="tree-item-h5-single tree-single tree-jump" data-url="' + liUrl + '" data-target="' + liTarget + '" onclick="jump(this, \'' + rootPath + liUrl + '\')">' + liVal + '</h5>');
                                } else {
                    ...
                    if (!!liUrl) {
                        var liEl2 = $('<h4 class="tree-item-h4-single tree-single tree-jump" data-url="' + liUrl + '" data-target="' + liTarget + '" onclick="jump(this, \'' + rootPath + liUrl + '\')">' + liVal + '</h4>');
                    } else {
