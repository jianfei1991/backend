<template>
<div class="main-tab">
    <h3><i class="el-icon-menu"></i>&nbsp;&nbsp;事故处理列表</h3>
    <!-- 下拉菜单群组 -->
    ...
    <div class="main-time">
        <div>
            <label class="ellipsis" for="">时间：</label>
        ...
        <div>
            <label class="ellipsis" for="">订单号：</label>
            <el-input  class="form-input" type="text" placeholder="请输入订单号"></el-input>
    ...
    <div class="main-table">
        <el-table ref="singleTable" stripe :data="tableData" highlight-current-row style="width: 100%">
            ...
            <el-table-column property="name"label="责任人类型"></el-table-column>
            <el-table-column property="phone"label="责任人手机号"></el-table-column>
            <el-table-column property="status"label="接报时间"></el-table-column>
            <el-table-column property="state"label="是否需要保修"></el-table-column>
            <el-table-column property="duration"label="报案号"></el-table-column>
            <el-table-column property="symbol"label="是否销案"></el-table-column>
            <el-table-column property="type"label="是否送修"></el-table-column>
            <el-table-column property="sheet"label="事故出现节点"></el-table-column>

            <el-table-column label="操作" width="">
                <template slot-scope="scope">
                    <el-button @click="handleClick(scope.row)" type="primary" size="small">处理</el-button>
